...
*/
class managedoctorreservesController extends doctorreservelistController {
	private $PAGESIZE=10;
	public function DeleteItem($ID)
	{
		...
		$doctorreserveEnt->setId($ID);
		if($doctorreserveEnt->getId()==-1)
			throw new DataNotFoundException();
		if($UserID!=null && $doctorreserveEnt->getRole_systemuser_fid()!=$UserID)
			throw new DataNotFoundException();
		$doctorreserveEnt->Remove();
