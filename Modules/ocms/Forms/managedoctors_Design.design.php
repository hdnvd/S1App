...
*/
class managedoctors_Design extends FormDesign {
	private $Data;
	/**
	 * @param mixed $Data
	 */
    ...
    public function setAdminMode($adminMode)
    {
        ...
        $this->itemViewPage = 'doctor';
        if($adminMode==true)
        {
            $this->itemPage = 'managedoctor';
            $this->listPage = 'managedoctors';
        }
        else
        {
            $this->itemPage = 'manageuserdoctor';
            $this->listPage = 'manageuserdoctors';
        }
    }
	...
	public function getBodyHTML($command=null)
	{
		...
		$lnkSearch->setId('searchdoctorlink');
