...
*/
class managespecialitys_Design extends FormDesign {
	private $Data;
	/**
	 * @param mixed $Data
	 */
    ...
    public function setAdminMode($adminMode)
    {
        ...
        $this->itemViewPage = 'speciality';
        if($adminMode==true)
        {
            $this->itemPage = 'managespeciality';
            $this->listPage = 'managespecialitys';
        }
        else
        {
            $this->itemPage = 'manageuserspeciality';
            $this->listPage = 'manageuserspecialitys';
        }
    }
	...
	public function getBodyHTML($command=null)
	{
		...
		$Page->setId("ocms_managespecialitys");
		$Page->addElement($this->getPageTitlePart("مدیریت " . $this->Data['speciality']->getTableTitle() . " ها"));
		...
		$lnkAdd->setId('addspecialitylink');
		...
		$lnkSearch->setId('searchspecialitylink');
