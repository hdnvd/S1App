...
use Modules\ocms\Controllers\specialitylistController;
...
*/
class specialitylist_Code extends FormCode {
	private $searchForm='specialitylist';
	...
	{
		$specialitylistController=new specialitylistController();
		$translator=new ModuleTranslator("ocms");
		$translator->setLanguageName(CurrentLanguageManager::getCurrentLanguageName());
		try{
			$design=new specialitylist_Design();
	...
	public function search_Click()
	{
		...
		$specialitylistController->setAdminMode($this->getAdminMode());
		...
		$Result=$specialitylistController->Search($this->getHttpGETparameter('pn',-1),$title,$speciality_fid_ID,$sortby_ID,$isdesc_ID);
		$design->setData($Result);
