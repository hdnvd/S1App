...
*/
class managedoctorreserves_Design extends FormDesign {
	private $Data;
	/**
	 * @param mixed $Data
	 */
    ...
    public function setAdminMode($adminMode)
    {
        ...
        $this->itemViewPage = 'doctorreserve';
        if($adminMode==true)
        {
            $this->itemPage = 'managedoctorreserve';
            $this->listPage = 'managedoctorreserves';
        }
        else
        {
            $this->itemPage = 'manageuserdoctorreserve';
            $this->listPage = 'manageuserdoctorreserves';
        }
    }
	...
	public function getBodyHTML($command=null)
	{
		...
		$Page->setId("ocms_managedoctorreserves");
		$Page->addElement($this->getPageTitlePart("مدیریت " . $this->Data['doctorreserve']->getTableTitle() . " ها"));
		...
		$lnkAdd->setId('adddoctorreservelink');
		...
		$lnkSearch->setId('searchdoctorreservelink');
