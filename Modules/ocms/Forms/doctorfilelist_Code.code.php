...
use Modules\ocms\Controllers\doctorfilelistController;
...
*/
class doctorfilelist_Code extends FormCode {
	private $searchForm='doctorfilelist';
	...
	{
		$doctorfilelistController=new doctorfilelistController();
		$translator=new ModuleTranslator("ocms");
		$translator->setLanguageName(CurrentLanguageManager::getCurrentLanguageName());
		try{
			$design=new doctorfilelist_Design();
			...
			{
				$Result=$doctorfilelistController->load($this->getHttpGETparameter('pn',-1),$this->getHttpGETparameter('doctorid',-1));
	...
	public function search_Click()
	{
		...
		$doctorfilelistController->setAdminMode($this->getAdminMode());
		...
		$Result=$doctorfilelistController->Search($this->getHttpGETparameter('pn',-1),$description,$doctor_fid_ID,$sortby_ID,$isdesc_ID);
		$design->setData($Result);
