...
class ocms_doctorreserveEntity extends EntityClass {
	public function __construct(dbaccess $DBAccessor)
	{
		...
		$this->addTableField('3',ocms_doctorreserveEntity::$PRESENCETYPE_FID);
		...
		$this->addTableField('4',ocms_doctorreserveEntity::$RESERVE_DATE);
		...
		$this->addTableField('5',ocms_doctorreserveEntity::$ROLE_SYSTEMUSER_FID);
	}
