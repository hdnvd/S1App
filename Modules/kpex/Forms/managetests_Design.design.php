...
//            $t=new kpex_testEntity();
            ...
            $LTable1->setLastElementClass("listcontent");
            $LTable1->addElement(new Lable($this->Data['data'][$i]->getPrecisionrate()));
            $LTable1->setLastElementClass("listcontent");
            $LTable1->addElement(new Lable($this->Data['data'][$i]->getRecall()));
            $LTable1->setLastElementClass("listcontent");
            $LTable1->addElement(new Lable($this->Data['data'][$i]->getFscore()));
            $LTable1->setLastElementClass("listcontent");
