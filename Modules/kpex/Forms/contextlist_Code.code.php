...
use Modules\kpex\Controllers\contextlistController;
...
*/
class contextlist_Code extends FormCode {
	private $searchForm='contextlist';
	...
	{
		$contextlistController=new contextlistController();
		$translator=new ModuleTranslator("kpex");
		$translator->setLanguageName(CurrentLanguageManager::getCurrentLanguageName());
		try{
			$design=new contextlist_Design();
			...
			{
				$Result=$contextlistController->load($this->getHttpGETparameter('pn',-1));
	...
	public function search_Click()
	{
		...
		$contextlistController->setAdminMode($this->getAdminMode());
		$url=$this->getHttpGETparameter('url','');
		$title=$this->getHttpGETparameter('title','');
		$content=$this->getHttpGETparameter('content','');
		$words=$this->getHttpGETparameter('words','');
		$sortby_ID=$this->getHttpGETparameter('sortby','');
		$isdesc_ID=$this->getHttpGETparameter('isdesc','');
		$Result=$contextlistController->Search($this->getHttpGETparameter('pn',-1),$url,$title,$content,$words,$sortby_ID,$isdesc_ID);
		$design->setData($Result);
