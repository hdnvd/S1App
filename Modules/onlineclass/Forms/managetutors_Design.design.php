...
*/
class managetutors_Design extends FormDesign {
	private $Data;
	/**
	 * @param mixed $Data
	 */
    ...
    public function setAdminMode($adminMode)
    {
        ...
        $this->itemViewPage = 'tutor';
        if($adminMode==true)
        {
            $this->itemPage = 'managetutor';
            $this->listPage = 'managetutors';
        }
        else
        {
            $this->itemPage = 'manageusertutor';
            $this->listPage = 'manageusertutors';
        }
    }
	...
	public function getBodyHTML($command=null)
	{
		...
		$Page->setId("onlineclass_managetutors");
		$Page->addElement($this->getPageTitlePart("مدیریت " . $this->Data['tutor']->getTableTitle() . " ها"));
		...
		$lnkSearch->setId('searchtutorlink');
