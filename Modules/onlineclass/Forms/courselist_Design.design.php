...
*/
class courselist_Design extends FormDesign {
	private $Data;
	/**
	 * @param mixed $Data
	 */
	...
	public function getBodyHTML($command=null)
	{
		...
		$Page->addElement($this->getPageTitlePart("فهرست " . $this->Data['course']->getTableTitle() . " ها"));
		$LTable1=new Div();
		...
		$innerDiv[$i]->setClass("listitem");
			$url=new AppRooter('onlineclass','course');
		...
		$Page->addElement($this->getPaginationPart($this->Data['pagecount'],"onlineclass","courselist"));
		$PageLink=new AppRooter('onlineclass','courselist');
