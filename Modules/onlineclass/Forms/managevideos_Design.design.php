...
*/
class managevideos_Design extends FormDesign {
	private $Data;
	/**
	 * @param mixed $Data
	 */
    ...
    public function setAdminMode($adminMode)
    {
        ...
        $this->itemViewPage = 'video';
        if($adminMode==true)
        {
            $this->itemPage = 'managevideo';
            $this->listPage = 'managevideos';
        }
        else
        {
            $this->itemPage = 'manageuservideo';
            $this->listPage = 'manageuservideos';
        }
    }
	...
	public function getBodyHTML($command=null)
	{
		...
		$Page->setId("onlineclass_managevideos");
		$Page->addElement($this->getPageTitlePart("مدیریت " . $this->Data['video']->getTableTitle() . " ها"));
		...
		$lnkSearch->setId('searchvideolink');
