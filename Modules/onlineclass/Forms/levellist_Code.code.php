...
use Modules\onlineclass\Controllers\levellistController;
...
*/
class levellist_Code extends FormCode {
	private $searchForm='levellist';
	...
	public function getLoadDesign()
	{
		...
		try{
			...
			{
				$Result=$levellistController->load($this->getHttpGETparameter('pn',-1));
	...
	public function search_Click()
	{
		...
		$levellistController->setAdminMode($this->getAdminMode());
		...
		$Result=$levellistController->Search($this->getHttpGETparameter('pn',-1),$title,$priority,$sortby_ID,$isdesc_ID);
		$design->setData($Result);
