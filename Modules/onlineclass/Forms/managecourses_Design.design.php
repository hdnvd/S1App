...
*/
class managecourses_Design extends FormDesign {
	private $Data;
	/**
	 * @param mixed $Data
	 */
    ...
    public function setAdminMode($adminMode)
    {
        ...
        $this->itemViewPage = 'course';
        if($adminMode==true)
        {
            $this->itemPage = 'managecourse';
            $this->listPage = 'managecourses';
        }
        else
        {
	...
	public function getBodyHTML($command=null)
	{
		...
		$Page->setId("onlineclass_managecourses");
		$Page->addElement($this->getPageTitlePart("مدیریت " . $this->Data['course']->getTableTitle() . " ها"));
		...
		$lnkSearch->setId('searchcourselink');
