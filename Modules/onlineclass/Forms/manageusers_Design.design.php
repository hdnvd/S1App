...
class manageusers_Design extends FormDesign {
    ...
    public function setAdminMode($adminMode)
    {
        ...
        $this->itemViewPage = 'user';
        if($adminMode==true)
        {
            $this->itemPage = 'manageuser';
            $this->listPage = 'manageusers';
        }
        else
        {
            $this->itemPage = 'manageuseruser';
            $this->listPage = 'manageuserusers';
        }
    }
	...
	public function getBodyHTML($command=null)
	{
		...
		$Page->setId("onlineclass_manageusers");
		$Page->addElement($this->getPageTitlePart("مدیریت " . $this->Data['user']->getTableTitle() . " ها"));
		...
		$lnkSearch->setId('searchuserlink');
