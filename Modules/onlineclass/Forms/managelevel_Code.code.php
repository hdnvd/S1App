...
use Modules\onlineclass\Controllers\managelevelController;
...
*/
class managelevel_Code extends FormCode {    
	...
	{
		$managelevelController=new managelevelController();
		$managelevelController->setAdminMode($this->getAdminMode());
		$translator=new ModuleTranslator("onlineclass");
		$translator->setLanguageName(CurrentLanguageManager::getCurrentLanguageName());
		try{
			$Result=$managelevelController->load($this->getID());
			$design=new managelevel_Design();
	...
	public function btnSave_Click()
	{
		...
		$Result=$managelevelController->BtnSave($this->getID(),$title,$priority);
		$design->setData($Result);
		$design->setMessage("اطلاعات با موفقیت ذخیره شد.");
		$design->setMessageType(MessageType::$SUCCESS);
		if($this->getAdminMode()){
			$ManageListRooter=new AppRooter("onlineclass","managelevels");
		}
