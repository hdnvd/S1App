...
*/
class managelevels_Design extends FormDesign {
	private $Data;
	/**
	 * @param mixed $Data
	 */
    ...
    public function setAdminMode($adminMode)
    {
        ...
        $this->itemViewPage = 'level';
        if($adminMode==true)
        {
            $this->itemPage = 'managelevel';
            $this->listPage = 'managelevels';
        }
        else
        {
            $this->itemPage = 'manageuserlevel';
            $this->listPage = 'manageuserlevels';
        }
    }
	...
	public function getBodyHTML($command=null)
	{
		...
		$Page->setId("onlineclass_managelevels");
		$Page->addElement($this->getPageTitlePart("مدیریت " . $this->Data['level']->getTableTitle() . " ها"));
		...
		$lnkSearch->setId('searchlevellink');
