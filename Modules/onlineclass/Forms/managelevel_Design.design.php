...
*/
class managelevel_Design extends FormDesign {
	public function getBodyHTML($command=null)
	{
		$this->FillItems();
		$Page=new Div();
		$Page->setClass("sweet_formtitle");
		$Page->setId("onlineclass_managelevel");
		$Page->addElement($this->getPageTitlePart("مدیریت " . $this->Data['level']->getTableTitle() . ""));
		if($this->getMessage()!="")
	...
	public function FillItems()
	{
		...
		if (key_exists("level", $this->Data)){
			...
			$this->title->setFieldInfo($this->Data['level']->getFieldInfo('title'));
		}
		...
		if (key_exists("level", $this->Data)){
			...
			$this->priority->setFieldInfo($this->Data['level']->getFieldInfo('priority'));
		}
