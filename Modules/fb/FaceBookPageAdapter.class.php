...
public function Post($AccessToken,$UserKey,$AppSecret,$Page,$title,$targetUrl,$imgUrl,$description)
{
$facebookData = array();
$facebookData['consumer_key'] = $UserKey;//
$facebookData['consumer_secret'] = $AppSecret;
$facebook = new FacebookApi($Page,$facebookData);
$facebook->share($title, $targetUrl, $imgUrl, $description, $AccessToken);
}
}
?>
<?php
...
$this->page=$page;
    ...
    function share($title, $targetUrl, $imgUrl, $description, $access_token){
        ...
        // post to Facebook
        try {
          $ret = $this->connection->api('/' . $this->page . '/feed', 'POST', $params);
        } catch(Exception $e) {
          $e->getMessage();
        }
