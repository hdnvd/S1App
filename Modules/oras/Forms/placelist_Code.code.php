...
use Modules\oras\Controllers\placelistController;
...
*/
class placelist_Code extends FormCode {
	private $searchForm='placelist';
	...
	{
		$placelistController=new placelistController();
		$translator=new ModuleTranslator("oras");
		$translator->setLanguageName(CurrentLanguageManager::getCurrentLanguageName());
		try{
			$design=new placelist_Design();
			...
			{
				$Result=$placelistController->load($this->getHttpGETparameter('pn',-1));
	...
	public function search_Click()
	{
		...
		$placelistController->setAdminMode($this->getAdminMode());
		$title=$this->getHttpGETparameter('title','');
		$sortby_ID=$this->getHttpGETparameter('sortby','');
		$isdesc_ID=$this->getHttpGETparameter('isdesc','');
		$Result=$placelistController->Search($this->getHttpGETparameter('pn',-1),$title,$sortby_ID,$isdesc_ID);
		$design->setData($Result);
