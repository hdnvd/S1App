...
*/
class managerecordtypes_Design extends FormDesign {
	private $Data;
	/**
	 * @param mixed $Data
	 */
    ...
    public function setAdminMode($adminMode)
    {
        ...
        if($adminMode==true)
        {
            $this->itemPage = 'managerecordtype';
            $this->listPage = 'managerecordtypes';
        }
        else
        {
            $this->itemPage = 'manageuserrecordtype';
            $this->listPage = 'manageuserrecordtypes';
        }
    }
	...
	public function getBodyHTML($command=null)
	{
		...
		$Page->setId("oras_managerecordtypes");
		$Page->addElement($this->getPageTitlePart("مدیریت " . $this->Data['recordtype']->getTableTitle() . " ها"));
		...
		$lnkAdd->setId('addrecordtypelink');
		...
		$lnkSearch->setId('searchrecordtypelink');
