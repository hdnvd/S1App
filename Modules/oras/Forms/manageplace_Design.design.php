...
*/
class manageplace_Design extends FormDesign {
	public function getBodyHTML($command=null)
	{
		$this->FillItems();
		$Page=new Div();
		$Page->setClass("sweet_formtitle");
		$Page->setId("oras_manageplace");
		$Page->addElement($this->getPageTitlePart("مدیریت " . $this->Data['place']->getTableTitle() . ""));
		if($this->getMessage()!="")
	...
	public function FillItems()
	{
		...
		if (key_exists("place", $this->Data)){
			...
			$this->title->setFieldInfo($this->Data['place']->getFieldInfo('title'));
		}
