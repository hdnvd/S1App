...
*/
class manageemployeerecruitmenttypes_Design extends FormDesign {
	private $Data;
	/**
	 * @param mixed $Data
	 */
    ...
    public function setAdminMode($adminMode)
    {
        ...
        if($adminMode==true)
        {
            $this->itemPage = 'manageemployeerecruitmenttype';
            $this->listPage = 'manageemployeerecruitmenttypes';
        }
        else
        {
            $this->itemPage = 'manageuseremployeerecruitmenttype';
            $this->listPage = 'manageuseremployeerecruitmenttypes';
        }
    }
	...
	public function getBodyHTML($command=null)
	{
		...
		$Page->setId("oras_manageemployeerecruitmenttypes");
		$Page->addElement($this->getPageTitlePart("مدیریت " . $this->Data['employeerecruitmenttype']->getTableTitle() . " ها"));
		...
		$lnkAdd->setId('addemployeerecruitmenttypelink');
		...
		$lnkSearch->setId('searchemployeerecruitmenttypelink');
