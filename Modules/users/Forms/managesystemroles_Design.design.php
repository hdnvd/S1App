...
*/
class managesystemroles_Design extends FormDesign {
	private $Data;
	/**
	 * @param mixed $Data
	 */
    ...
    public function setAdminMode($adminMode)
    {
        ...
        $this->itemViewPage = 'systemrole';
        if($adminMode==true)
        {
            $this->itemPage = 'managesystemrole';
            $this->listPage = 'managesystemroles';
        }
        else
        {
            $this->itemPage = 'manageusersystemrole';
            $this->listPage = 'manageusersystemroles';
        }
    }
	...
	public function getBodyHTML($command=null)
	{
		...
		$Page->setId("users_managesystemroles");
		$Page->addElement($this->getPageTitlePart("مدیریت " . $this->Data['systemrole']->getTableTitle() . " ها"));
		...
		$lnkAdd->setId('addsystemrolelink');
		...
		$lnkSearch->setId('searchsystemrolelink');
