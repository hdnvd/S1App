...
use Modules\users\Controllers\systemtasklistController;
...
*/
class systemtasklist_Code extends FormCode {
	private $searchForm='systemtasklist';
	...
	{
		$systemtasklistController=new systemtasklistController();
		$translator=new ModuleTranslator("users");
		$translator->setLanguageName(CurrentLanguageManager::getCurrentLanguageName());
		try{
			$design=new systemtasklist_Design();
			...
			{
				$Result=$systemtasklistController->load($this->getHttpGETparameter('pn',-1));
	...
	public function search_Click()
	{
		...
		$systemtasklistController->setAdminMode($this->getAdminMode());
		$module=$this->getHttpGETparameter('module','');
		$page=$this->getHttpGETparameter('page','');
		$action=$this->getHttpGETparameter('action','');
		$sortby_ID=$this->getHttpGETparameter('sortby','');
		$isdesc_ID=$this->getHttpGETparameter('isdesc','');
		$Result=$systemtasklistController->Search($this->getHttpGETparameter('pn',-1),$module,$page,$action,$sortby_ID,$isdesc_ID);
		$design->setData($Result);
