 ...
 *@CreationDate 2015/06/25 19:39:12
 *@LastUpdate 2015/06/25 19:39:12
 *@TableName keyword
 *@TableFields title t
 *@SweetFrameworkHelperVersion 1.103
 *@TableCreationSQL
 
CREATE TABLE IF NOT EXISTS employment_keyword (
...
class employment_keywordEntity extends EntityClass {
	/**
	 * @var updateQuery
	 */
	private $UpdateQuery;
	...
	public function __construct(dbaccess $DBAccessor)
	{
		...
		$this->setTableName("employment_keyword");
	}
