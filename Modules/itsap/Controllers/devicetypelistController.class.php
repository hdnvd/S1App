...
class devicetypelistController extends Controller {
	...
	public function getData($PageNum,QueryLogic $QueryLogic)
	{
		...
		if($UserID!=null)
            $QueryLogic->addCondition(new FieldCondition(itsap_devicetypeEntity::$ROLE_SYSTEMUSER_FID,$UserID));
		$devicetypeEnt=new itsap_devicetypeEntity($DBAccessor);
		$result['devicetype']=$devicetypeEnt;
		$allcount=$devicetypeEnt->FindAllCount($QueryLogic);
		$result['pagecount']=$this->getPageCount($allcount,$this->PAGESIZE);
		$QueryLogic->setLimit($this->getPageRowsLimit($PageNum,$this->PAGESIZE));
		$result['data']=$devicetypeEnt->FindAll($QueryLogic);
	...
	public function Search($PageNum,$title,$sortby,$isdesc)
	{
		...
		$sortByField=$devicetypeEnt->getTableField($sortby);
		if($sortByField!=null)
