...
use Modules\itsap\Controllers\manageemployeeController;
...
class manageemployee_Code extends FormCode {    
	...
	public function btnSave_Click()
	{
		...
		$degree_fid_ID=$design->getDegree_fid()->getSelectedID();
		$Result=$manageemployeeController->BtnSave($this->getID(),$unit_fid_ID,$emp_code,$mellicode,$name,$family,$mobile,$degree_fid_ID);
		$design->setData($Result);
