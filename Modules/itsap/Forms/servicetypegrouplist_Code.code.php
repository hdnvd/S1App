...
use Modules\itsap\Controllers\servicetypegrouplistController;
...
*/
class servicetypegrouplist_Code extends FormCode {
	private $searchForm='servicetypegrouplist';
	...
	{
		$servicetypegrouplistController=new servicetypegrouplistController();
		$translator=new ModuleTranslator("itsap");
		$translator->setLanguageName(CurrentLanguageManager::getCurrentLanguageName());
		try{
			$design=new servicetypegrouplist_Design();
			...
			{
				$Result=$servicetypegrouplistController->load($this->getHttpGETparameter('pn',-1));
	...
	public function __construct($namespace)
	{
		...
		$this->setTitle("Servicetypegroup List");
	}
	public function search_Click()
	{
		...
		$servicetypegrouplistController->setAdminMode($this->getAdminMode());
		...
		$Result=$servicetypegrouplistController->Search($this->getHttpGETparameter('pn',-1),$title,$servicetypegroup_fid_ID,$sortby_ID,$isdesc_ID);
		$design->setData($Result);
