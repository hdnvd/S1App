...
*/
class managedevicetypes_Design extends FormDesign {
	private $Data;
	/**
	 * @param mixed $Data
	 */
    ...
    public function setAdminMode($adminMode)
    {
        ...
        $this->itemViewPage = 'devicetype';
        if($adminMode==true)
        {
            $this->itemPage = 'managedevicetype';
            $this->listPage = 'managedevicetypes';
        }
        else
        {
            $this->itemPage = 'manageuserdevicetype';
            $this->listPage = 'manageuserdevicetypes';
        }
    }
	...
	public function getBodyHTML($command=null)
	{
		...
		$Page->setId("itsap_managedevicetypes");
		$Page->addElement($this->getPageTitlePart("مدیریت " . $this->Data['devicetype']->getTableTitle() . " ها"));
		...
		$lnkAdd->setId('adddevicetypelink');
		...
		$lnkSearch->setId('searchdevicetypelink');
