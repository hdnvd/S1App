...
*/
class managedegree_Design extends FormDesign {
	public function getBodyHTML($command=null)
	{
		$this->FillItems();
		$Page=new Div();
		$Page->setClass("sweet_formtitle");
		$Page->setId("itsap_managedegree");
		$Page->addElement($this->getPageTitlePart("مدیریت " . $this->Data['degree']->getTableTitle() . ""));
		if($this->getMessage()!="")
	...
	public function FillItems()
	{
		if (key_exists("degree", $this->Data)){
			...
			$this->title->setFieldInfo($this->Data['degree']->getFieldInfo('title'));
			...
			$this->priority->setFieldInfo($this->Data['degree']->getFieldInfo('priority'));
