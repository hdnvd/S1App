...
*/
class managedevicecomponents_Design extends FormDesign {
	private $Data;
	/**
	 * @param mixed $Data
	 */
    ...
    public function setAdminMode($adminMode)
    {
        ...
        $this->itemViewPage = 'devicecomponent';
        if($adminMode==true)
        {
            $this->itemPage = 'managedevicecomponent';
            $this->listPage = 'managedevicecomponents';
        }
        else
        {
            $this->itemPage = 'manageuserdevicecomponent';
            $this->listPage = 'manageuserdevicecomponents';
        }
    }
	...
	public function getBodyHTML($command=null)
	{
		...
		$Page->setId("itsap_managedevicecomponents");
		$Page->addElement($this->getPageTitlePart("مدیریت " . $this->Data['devicecomponent']->getTableTitle() . " ها"));
		...
		$lnkSearch->setId('searchdevicecomponentlink');
