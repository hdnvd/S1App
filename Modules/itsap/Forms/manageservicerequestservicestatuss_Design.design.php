...
*/
class manageservicerequestservicestatuss_Design extends FormDesign {
	private $Data;
	/**
	 * @param mixed $Data
	 */
    ...
    public function setAdminMode($adminMode)
    {
        ...
        $this->itemViewPage = 'servicerequestservicestatus';
        if($adminMode==true)
        {
            $this->itemPage = 'manageservicerequestservicestatus';
            $this->listPage = 'manageservicerequestservicestatuss';
        }
        else
        {
            $this->itemPage = 'manageuserservicerequestservicestatus';
            $this->listPage = 'manageuserservicerequestservicestatuss';
        }
    }
	...
	public function getBodyHTML($command=null)
	{
		...
		$Page->setId("itsap_manageservicerequestservicestatuss");
		$Page->addElement($this->getPageTitlePart("مدیریت " . $this->Data['servicerequestservicestatus']->getTableTitle() . " ها"));
		...
		$lnkAdd->setId('addservicerequestservicestatuslink');
		...
		$lnkSearch->setId('searchservicerequestservicestatuslink');
