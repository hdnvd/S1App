...
*/
class managetopunit_Design extends FormDesign {
	public function getBodyHTML($command=null)
	{
		$this->FillItems();
		$Page=new Div();
		$Page->setClass("sweet_formtitle");
		$Page->setId("itsap_managetopunit");
		$Page->addElement($this->getPageTitlePart("مدیریت " . $this->Data['topunit']->getTableTitle() . ""));
		if($this->getMessage()!="")
	...
	public function FillItems()
	{
		...
		if (key_exists("topunit", $this->Data)){
			...
			$this->title->setFieldInfo($this->Data['topunit']->getFieldInfo('title'));
