...
use Modules\itsap\Controllers\devicetypelistController;
...
*/
class devicetypelist_Code extends FormCode {
	private $searchForm='devicetypelist';
	...
	{
		$devicetypelistController=new devicetypelistController();
		$translator=new ModuleTranslator("itsap");
		$translator->setLanguageName(CurrentLanguageManager::getCurrentLanguageName());
		try{
			$design=new devicetypelist_Design();
			...
			{
				$Result=$devicetypelistController->load($this->getHttpGETparameter('pn',-1));
	...
	public function search_Click()
	{
		...
		$devicetypelistController->setAdminMode($this->getAdminMode());
		$title=$this->getHttpGETparameter('title','');
		$sortby_ID=$this->getHttpGETparameter('sortby','');
		$isdesc_ID=$this->getHttpGETparameter('isdesc','');
		$Result=$devicetypelistController->Search($this->getHttpGETparameter('pn',-1),$title,$sortby_ID,$isdesc_ID);
		$design->setData($Result);
