...
use Modules\itsap\Controllers\manageunitsController;
...
*/
class manageunits_Code extends unitlist_Code {
	...
	{
		try{
		$manageunitsController=new manageunitsController();
		$manageunitsController->setAdminMode($this->getAdminMode());
