...
*/
class managedevicetype_Design extends FormDesign {
	public function getBodyHTML($command=null)
	{
		$this->FillItems();
		$Page=new Div();
		$Page->setClass("sweet_formtitle");
		$Page->setId("itsap_managedevicetype");
		$Page->addElement($this->getPageTitlePart("مدیریت " . $this->Data['devicetype']->getTableTitle() . ""));
		if($this->getMessage()!="")
	...
	public function FillItems()
	{
		if (key_exists("devicetype", $this->Data)){
			...
			$this->title->setFieldInfo($this->Data['devicetype']->getFieldInfo('title'));
