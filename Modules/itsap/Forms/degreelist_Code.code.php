...
use Modules\itsap\Controllers\degreelistController;
...
*/
class degreelist_Code extends FormCode {
	private $searchForm='degreelist';
	...
	{
		$degreelistController=new degreelistController();
		$translator=new ModuleTranslator("itsap");
		$translator->setLanguageName(CurrentLanguageManager::getCurrentLanguageName());
		try{
			$design=new degreelist_Design();
			...
			{
				$Result=$degreelistController->load($this->getHttpGETparameter('pn',-1));
	...
	public function search_Click()
	{
		...
		$degreelistController->setAdminMode($this->getAdminMode());
		...
		$Result=$degreelistController->Search($this->getHttpGETparameter('pn',-1),$title,$priority,$sortby_ID,$isdesc_ID);
		$design->setData($Result);
