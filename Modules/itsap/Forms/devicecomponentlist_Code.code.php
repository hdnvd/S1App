...
use Modules\itsap\Controllers\devicecomponentlistController;
...
*/
class devicecomponentlist_Code extends FormCode {
	private $searchForm='devicecomponentlist';
	...
	{
		$devicecomponentlistController=new devicecomponentlistController();
		$translator=new ModuleTranslator("itsap");
		$translator->setLanguageName(CurrentLanguageManager::getCurrentLanguageName());
		try{
			$design=new devicecomponentlist_Design();
			...
			{
				$Result=$devicecomponentlistController->load($this->getHttpGETparameter('pn',-1));
	...
	public function __construct($namespace)
	{
		...
		$this->setTitle("Devicecomponent List");
	}
	public function search_Click()
	{
		...
		$devicecomponentlistController->setAdminMode($this->getAdminMode());
		...
		$Result=$devicecomponentlistController->Search($this->getHttpGETparameter('pn',-1),$devicetype_fid_ID,$title,$sortby_ID,$isdesc_ID);
		$design->setData($Result);
