...
*/
class manageservicetypegroups_Design extends FormDesign {
	private $Data;
	/**
	 * @param mixed $Data
	 */
    ...
    public function setAdminMode($adminMode)
    {
        ...
        $this->itemViewPage = 'servicetypegroup';
        if($adminMode==true)
        {
            $this->itemPage = 'manageservicetypegroup';
            $this->listPage = 'manageservicetypegroups';
        }
        else
        {
            $this->itemPage = 'manageuserservicetypegroup';
            $this->listPage = 'manageuserservicetypegroups';
        }
    }
	...
	public function getBodyHTML($command=null)
	{
		...
		$Page->setId("itsap_manageservicetypegroups");
		$Page->addElement($this->getPageTitlePart("مدیریت " . $this->Data['servicetypegroup']->getTableTitle() . " ها"));
		...
		$lnkAdd->setId('addservicetypegrouplink');
		...
		$lnkSearch->setId('searchservicetypegrouplink');
