...
*/
class servicetypegrouplistsearch_Design extends FormDesign {
	private $Data;
	/**
	 * @param mixed $Data
	 */
	...
	public function getBodyHTML($command=null)
	{
		...
		$Page->setId("itsap_servicetypegrouplist");
		$Page->addElement($this->getPageTitlePart("جستجوی " . $this->Data['servicetypegroup']->getTableTitle() . ""));
		if($this->getMessage()!="")
	...
	public function FillItems()
	{
		...
		/******** title ********/
		$this->sortby->addOption($this->Data['servicetypegroup']->getTableFieldID('title'),$this->getFieldCaption('title'));
		if(isset($_GET['title']))
			$this->title->setValue($_GET['title']);

		/******** servicetypegroup_fid ********/
		$this->sortby->addOption($this->Data['servicetypegroup']->getTableFieldID('servicetypegroup_fid'),$this->getFieldCaption('servicetypegroup_fid'));
