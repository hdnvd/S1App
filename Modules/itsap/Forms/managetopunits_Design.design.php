...
*/
class managetopunits_Design extends FormDesign {
	private $Data;
	/**
	 * @param mixed $Data
	 */
    ...
    public function setAdminMode($adminMode)
    {
        ...
        if($adminMode==true)
        {
            ...
            $this->listPage = 'managetopunits';
        }
        else
        {
            $this->itemPage = 'manageusertopunit';
	...
	public function getBodyHTML($command=null)
	{
		...
		$lnkSearch->setId('searchtopunitlink');
