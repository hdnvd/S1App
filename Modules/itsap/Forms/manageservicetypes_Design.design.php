...
*/
class manageservicetypes_Design extends FormDesign {
	private $Data;
	/**
	 * @param mixed $Data
	 */
    ...
    public function setAdminMode($adminMode)
    {
        ...
        $this->itemViewPage = 'servicetype';
        if($adminMode==true)
        {
            $this->itemPage = 'manageservicetype';
            $this->listPage = 'manageservicetypes';
        }
        else
        {
            $this->itemPage = 'manageuserservicetype';
            $this->listPage = 'manageuserservicetypes';
        }
    }
	...
	public function getBodyHTML($command=null)
	{
		...
		$lnkAdd->setId('addservicetypelink');
		...
		$lnkSearch->setId('searchservicetypelink');
