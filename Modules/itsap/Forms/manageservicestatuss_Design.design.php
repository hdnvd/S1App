...
*/
class manageservicestatuss_Design extends FormDesign {
	private $Data;
	/**
	 * @param mixed $Data
	 */
    ...
    public function setAdminMode($adminMode)
    {
        ...
        $this->itemViewPage = 'servicestatus';
        if($adminMode==true)
        {
            $this->itemPage = 'manageservicestatus';
            $this->listPage = 'manageservicestatuss';
        }
        else
        {
            $this->itemPage = 'manageuserservicestatus';
            $this->listPage = 'manageuserservicestatuss';
        }
    }
	...
	public function getBodyHTML($command=null)
	{
		...
		$Page->setId("itsap_manageservicestatuss");
		$Page->addElement($this->getPageTitlePart("مدیریت " . $this->Data['servicestatus']->getTableTitle() . " ها"));
		...
		$lnkAdd->setId('addservicestatuslink');
		...
		$lnkSearch->setId('searchservicestatuslink');
