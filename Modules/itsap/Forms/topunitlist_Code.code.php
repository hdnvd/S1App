...
use Modules\itsap\Controllers\topunitlistController;
...
*/
class topunitlist_Code extends FormCode {
	private $searchForm='topunitlist';
	...
	{
		$topunitlistController=new topunitlistController();
		$translator=new ModuleTranslator("itsap");
		$translator->setLanguageName(CurrentLanguageManager::getCurrentLanguageName());
		try{
			$design=new topunitlist_Design();
			...
			{
				$Result=$topunitlistController->load($this->getHttpGETparameter('pn',-1));
	...
	public function search_Click()
	{
		...
		$topunitlistController->setAdminMode($this->getAdminMode());
		...
		$Result=$topunitlistController->Search($this->getHttpGETparameter('pn',-1),$topunit_fid_ID,$title,$sortby_ID,$isdesc_ID);
		$design->setData($Result);
