...
*/
class managedegrees_Design extends FormDesign {
	private $Data;
	/**
	 * @param mixed $Data
	 */
    ...
    public function setAdminMode($adminMode)
    {
        ...
        $this->itemViewPage = 'degree';
        if($adminMode==true)
        {
            $this->itemPage = 'managedegree';
            $this->listPage = 'managedegrees';
        }
        else
        {
            $this->itemPage = 'manageuserdegree';
            $this->listPage = 'manageuserdegrees';
        }
    }
	...
	public function getBodyHTML($command=null)
	{
		...
		$Page->setId("itsap_managedegrees");
		$Page->addElement($this->getPageTitlePart("مدیریت " . $this->Data['degree']->getTableTitle() . " ها"));
		...
		$lnkSearch->setId('searchdegreelink');
