...
*/
class managefiles_Design extends FormDesign {
	private $Data;
	/**
	 * @param mixed $Data
	 */
    ...
    public function setAdminMode($adminMode)
    {
        ...
        $this->itemViewPage = 'file';
        if($adminMode==true)
        {
            $this->itemPage = 'managefile';
            $this->listPage = 'managefiles';
        }
        else
        {
            $this->itemPage = 'manageuserfile';
            $this->listPage = 'manageuserfiles';
        }
    }
	...
	public function getBodyHTML($command=null)
	{
		...
		$Page->setId("fileshop_managefiles");
		$Page->addElement($this->getPageTitlePart("مدیریت " . $this->Data['file']->getTableTitle() . " ها"));
		...
		$lnkSearch->setId('searchfilelink');
