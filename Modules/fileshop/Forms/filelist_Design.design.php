...
*/
class filelist_Design extends FormDesign {
	private $Data;
	/**
	 * @param mixed $Data
	 */
	...
	public function getBodyHTML($command=null)
	{
		...
		$Page->addElement($this->getPageTitlePart("فهرست " . $this->Data['file']->getTableTitle() . " ها"));
		$LTable1=new Div();
		...
		$innerDiv[$i]->setClass("listitem");
			$url=new AppRooter('fileshop','file');
		...
		$Page->addElement($this->getPaginationPart($this->Data['pagecount'],"fileshop","filelist"));
		$PageLink=new AppRooter('fileshop','filelist');
