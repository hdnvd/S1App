...
*/
class productlist_Design extends FormDesign {
	private $Data;
	/**
	 * @param mixed $Data
	 */
	...
	public function getBodyHTML($command=null)
	{
		...
		$Page->addElement($this->getPageTitlePart("فهرست " . $this->Data['product']->getTableTitle() . " ها"));
		$LTable1=new Div();
		...
		$innerDiv[$i]->setClass("listitem");
			$url=new AppRooter('eshop','product');
		...
		$Page->addElement($this->getPaginationPart($this->Data['pagecount'],"eshop","productlist"));
		$PageLink=new AppRooter('eshop','productlist');
