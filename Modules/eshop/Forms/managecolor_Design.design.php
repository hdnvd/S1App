...
*/
class managecolor_Design extends FormDesign {
	public function getBodyHTML($command=null)
	{
		$this->FillItems();
		$Page=new Div();
		$Page->setClass("sweet_formtitle");
		$Page->setId("eshop_managecolor");
		$Page->addElement($this->getPageTitlePart("مدیریت " . $this->Data['color']->getTableTitle() . ""));
		if($this->getMessage()!="")
	...
	public function FillItems()
	{
		...
		if (key_exists("color", $this->Data)){
			...
			$this->title->setFieldInfo($this->Data['color']->getFieldInfo('title'));
		}
		...
		if (key_exists("color", $this->Data)){
			...
			$this->latintitle->setFieldInfo($this->Data['color']->getFieldInfo('latintitle'));
		}
