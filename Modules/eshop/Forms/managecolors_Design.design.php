...
*/
class managecolors_Design extends FormDesign {
	private $Data;
	/**
	 * @param mixed $Data
	 */
    ...
    public function setAdminMode($adminMode)
    {
        ...
        $this->itemViewPage = 'color';
        if($adminMode==true)
        {
            $this->itemPage = 'managecolor';
            $this->listPage = 'managecolors';
        }
        else
        {
            $this->itemPage = 'manageusercolor';
            $this->listPage = 'manageusercolors';
        }
    }
	...
	public function getBodyHTML($command=null)
	{
		...
		$Page->setId("eshop_managecolors");
		$Page->addElement($this->getPageTitlePart("مدیریت " . $this->Data['color']->getTableTitle() . " ها"));
		...
		$lnkSearch->setId('searchcolorlink');
