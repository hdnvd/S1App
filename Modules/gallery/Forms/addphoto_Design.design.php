 ...
 *        
 */
class addphoto_Design extends FormDesign {
	...
	public function getBodyHTML($command = "load") {
		...
		if($this->Img->getUrl()!="")
		{
		    $this->Img->setUrl("/" . $this->Img->getUrl());
			$table->addElement(new Lable("تصویر فعلی"));
			$table->addElement($this->Img);
		}
