...
*/
class managepaymentlicencesController extends paymentlicencelistController {
	private $PAGESIZE=10;
	public function DeleteItem($ID)
	{
		...
		$paymentlicenceEnt->setId($ID);
		if($paymentlicenceEnt->getId()==-1)
			throw new DataNotFoundException();
		if($UserID!=null && $paymentlicenceEnt->getRole_systemuser_fid()!=$UserID)
			throw new DataNotFoundException();
		$paymentlicenceEnt->Remove();
