...
*/
class manageactivitysController extends activitylistController {
	private $PAGESIZE=10;
	public function DeleteItem($ID)
	{
		...
		$activityEnt->setId($ID);
		if($activityEnt->getId()==-1)
			throw new DataNotFoundException();
		if($UserID!=null && $activityEnt->getRole_systemuser_fid()!=$UserID)
			throw new DataNotFoundException();
		$activityEnt->Remove();
