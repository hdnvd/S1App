...
*/
class manageprogramestimationsController extends programestimationlistController {
	private $PAGESIZE=10;
	public function DeleteItem($ID)
	{
		...
		$programestimationEnt->setId($ID);
		if($programestimationEnt->getId()==-1)
			throw new DataNotFoundException();
		if($UserID!=null && $programestimationEnt->getRole_systemuser_fid()!=$UserID)
			throw new DataNotFoundException();
		$programestimationEnt->Remove();
