...
*/
class classlist_Design extends FormDesign {
	private $Data;
	/**
	 * @param mixed $Data
	 */
	...
	public function getBodyHTML($command=null)
	{
		...
		$Page->setId("iribfinance_classlist");
		$Page->addElement($this->getPageTitlePart("فهرست " . $this->Data['class']->getTableTitle() . " ها"));
		$LTable1=new Div();
		...
		$innerDiv[$i]->setClass("listitem");
			$url=new AppRooter('iribfinance','class');
		...
		$Page->addElement($this->getPaginationPart($this->Data['pagecount'],"iribfinance","classlist"));
		$PageLink=new AppRooter('iribfinance','classlist');
	...
	public function FillItems()
	{
		if (key_exists("class", $this->Data)){
			...
			/******** title ********/
			$this->title->setValue($this->Data['class']->getTitle());
			$this->setFieldCaption('title',$this->Data['class']->getFieldInfo('title')->getTitle());
		...
		/******** title ********/
		$this->sortby->addOption($this->Data['class']->getTableFieldID('title'),$this->getFieldCaption('title'));
		if(isset($_GET['title']))
