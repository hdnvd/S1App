...
*@creationDate 1396-11-26 - 2018-02-15 14:26
*@lastUpdate 1396-11-26 - 2018-02-15 14:26
*@SweetFrameworkHelperVersion 2.004
*@SweetFrameworkVersion 2.004
*/
class departmentlist_Design extends FormDesign {
	private $Data;
	/**
	 * @param mixed $Data
	 */
	...
	public function getBodyHTML($command=null)
	{
		...
		$Page->addElement($this->getPageTitlePart("فهرست " . $this->Data['department']->getTableTitle() . " ها"));
		$LTable1=new Div();
		...
		$innerDiv[$i]->setClass("listitem");
			$url=new AppRooter('iribfinance','department');
		...
		$Page->addElement($this->getPaginationPart($this->Data['pagecount'],"iribfinance","departmentlist"));
		$PageLink=new AppRooter('iribfinance','departmentlist');
...
//			$Result=[0=>['id'=>1,'title'=>'salam','region_fid'=>"22"]];
