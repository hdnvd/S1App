...
*/
class manageprosperityfunds_Design extends FormDesign {
	private $Data;
	/**
	 * @param mixed $Data
	 */
    ...
    public function setAdminMode($adminMode)
    {
        ...
        $this->itemViewPage = 'prosperityfund';
        if($adminMode==true)
        {
            $this->itemPage = 'manageprosperityfund';
            $this->listPage = 'manageprosperityfunds';
        }
        else
        {
            $this->itemPage = 'manageuserprosperityfund';
            $this->listPage = 'manageuserprosperityfunds';
        }
    }
	...
	public function getBodyHTML($command=null)
	{
		...
		$Page->setId("iribfinance_manageprosperityfunds");
		$Page->addElement($this->getPageTitlePart("مدیریت " . $this->Data['prosperityfund']->getTableTitle() . " ها"));
		...
		$lnkAdd->setId('addprosperityfundlink');
		...
		$lnkSearch->setId('searchprosperityfundlink');
