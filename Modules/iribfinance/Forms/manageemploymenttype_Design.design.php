...
*/
class manageemploymenttype_Design extends FormDesign {
	public function getBodyHTML($command=null)
	{
		$this->FillItems();
		$Page=new Div();
		$Page->setClass("sweet_formtitle");
		$Page->setId("iribfinance_manageemploymenttype");
		$Page->addElement($this->getPageTitlePart("مدیریت " . $this->Data['employmenttype']->getTableTitle() . ""));
		if($this->getMessage()!="")
		...
		$LTable1->addElement($this->getFieldRowCode($this->taxfactor,$this->getFieldCaption('taxfactor'),null,'لطفا این فیلد را به طور صحیح وارد کنید',null));
	...
	public function FillItems()
	{
		if (key_exists("employmenttype", $this->Data)){
			...
			$this->title->setFieldInfo($this->Data['employmenttype']->getFieldInfo('title'));
			...
			$this->taxfactor->setFieldInfo($this->Data['employmenttype']->getFieldInfo('taxfactor'));
