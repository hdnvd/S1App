...
*/
class banklist_Design extends FormDesign {
	private $Data;
	/**
	 * @param mixed $Data
	 */
	...
	public function getBodyHTML($command=null)
	{
		...
		$Page->setId("iribfinance_banklist");
		$Page->addElement($this->getPageTitlePart("فهرست " . $this->Data['bank']->getTableTitle() . " ها"));
		$LTable1=new Div();
		...
		$innerDiv[$i]->setClass("listitem");
			$url=new AppRooter('iribfinance','bank');
		...
		$Page->addElement($this->getPaginationPart($this->Data['pagecount'],"iribfinance","banklist"));
		$PageLink=new AppRooter('iribfinance','banklist');
	...
	{
		if (key_exists("bank", $this->Data)){

			/******** title ********/
			$this->title->setValue($this->Data['bank']->getTitle());
			$this->setFieldCaption('title',$this->Data['bank']->getFieldInfo('title')->getTitle());
		...
		/******** title ********/
		$this->sortby->addOption($this->Data['bank']->getTableFieldID('title'),$this->getFieldCaption('title'));
		if(isset($_GET['title']))
