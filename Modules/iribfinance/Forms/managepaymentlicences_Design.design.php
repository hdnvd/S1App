...
*/
class managepaymentlicences_Design extends FormDesign {
	private $Data;
	/**
	 * @param mixed $Data
	 */
    ...
    public function setAdminMode($adminMode)
    {
        ...
        $this->itemViewPage = 'paymentlicence';
        if($adminMode==true)
        {
            $this->itemPage = 'managepaymentlicence';
            $this->listPage = 'managepaymentlicences';
        }
        else
        {
            $this->itemPage = 'manageuserpaymentlicence';
            $this->listPage = 'manageuserpaymentlicences';
        }
    }
	...
	public function getBodyHTML($command=null)
	{
		...
		$Page->setId("iribfinance_managepaymentlicences");
		$Page->addElement($this->getPageTitlePart("مدیریت " . $this->Data['paymentlicence']->getTableTitle() . " ها"));
		...
		$lnkAdd->setId('addpaymentlicencelink');
		...
		$lnkSearch->setId('searchpaymentlicencelink');
