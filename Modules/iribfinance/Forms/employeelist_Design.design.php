...
class employeelist_Design extends FormDesign {
	...
	public function getBodyHTML($command=null)
	{
		...
		$innerDiv[$i]->setClass("listitem");
			$url=new AppRooter('iribfinance','employee');
		...
		$Page->addElement($this->getPaginationPart($this->Data['pagecount'],"iribfinance","employeelist"));
		$PageLink=new AppRooter('iribfinance','employeelist');
