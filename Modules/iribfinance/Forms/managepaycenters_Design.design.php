...
*/
class managepaycenters_Design extends FormDesign {
	private $Data;
	/**
	 * @param mixed $Data
	 */
    ...
    public function setAdminMode($adminMode)
    {
        ...
        $this->itemViewPage = 'paycenter';
        if($adminMode==true)
        {
            $this->itemPage = 'managepaycenter';
            $this->listPage = 'managepaycenters';
        }
        else
        {
            $this->itemPage = 'manageuserpaycenter';
            $this->listPage = 'manageuserpaycenters';
        }
    }
	...
	public function getBodyHTML($command=null)
	{
		...
		$Page->setId("iribfinance_managepaycenters");
		$Page->addElement($this->getPageTitlePart("مدیریت " . $this->Data['paycenter']->getTableTitle() . " ها"));
		...
		$lnkSearch->setId('searchpaycenterlink');
