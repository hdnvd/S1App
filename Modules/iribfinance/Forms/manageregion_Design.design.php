...
*/
class manageregion_Design extends FormDesign {
	public function getBodyHTML($command=null)
	{
		$this->FillItems();
		$Page=new Div();
		$Page->setClass("sweet_formtitle");
		$Page->setId("iribfinance_manageregion");
		$Page->addElement($this->getPageTitlePart("مدیریت " . $this->Data['region']->getTableTitle() . ""));
		if($this->getMessage()!="")
	...
	public function FillItems()
	{
		if (key_exists("region", $this->Data)){
			...
			$this->title->setFieldInfo($this->Data['region']->getFieldInfo('title'));
