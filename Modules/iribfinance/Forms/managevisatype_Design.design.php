...
*/
class managevisatype_Design extends FormDesign {
	public function getBodyHTML($command=null)
	{
		$this->FillItems();
		$Page=new Div();
		$Page->setClass("sweet_formtitle");
		$Page->setId("iribfinance_managevisatype");
		$Page->addElement($this->getPageTitlePart("مدیریت " . $this->Data['visatype']->getTableTitle() . ""));
		if($this->getMessage()!="")
	...
	public function FillItems()
	{
		if (key_exists("visatype", $this->Data)){
			...
			$this->title->setFieldInfo($this->Data['visatype']->getFieldInfo('title'));
