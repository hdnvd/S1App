...
*/
class programmaketypelist_Design extends FormDesign {
	private $Data;
	/**
	 * @param mixed $Data
	 */
	...
	public function getBodyHTML($command=null)
	{
		...
		$Page->setId("iribfinance_programmaketypelist");
		$Page->addElement($this->getPageTitlePart("فهرست " . $this->Data['programmaketype']->getTableTitle() . " ها"));
		$LTable1=new Div();
		...
		$innerDiv[$i]->setClass("listitem");
			$url=new AppRooter('iribfinance','programmaketype');
		...
		$Page->addElement($this->getPaginationPart($this->Data['pagecount'],"iribfinance","programmaketypelist"));
		$PageLink=new AppRooter('iribfinance','programmaketypelist');
	...
	public function FillItems()
	{
		if (key_exists("programmaketype", $this->Data)){
			...
			/******** title ********/
			$this->title->setValue($this->Data['programmaketype']->getTitle());
		...
		/******** title ********/
		$this->sortby->addOption($this->Data['programmaketype']->getTableFieldID('title'),$this->getFieldCaption('title'));
		if(isset($_GET['title']))
