...
*/
class managedepartments_Design extends FormDesign {
	private $Data;
	/**
	 * @param mixed $Data
	 */
    ...
    public function setAdminMode($adminMode)
    {
        ...
        $this->itemViewPage = 'department';
        if($adminMode==true)
        {
            $this->itemPage = 'managedepartment';
            $this->listPage = 'managedepartments';
        }
        else
        {
            $this->itemPage = 'manageuserdepartment';
            $this->listPage = 'manageuserdepartments';
        }
    }
	...
	public function getBodyHTML($command=null)
	{
		...
		$Page->setId("iribfinance_managedepartments");
		$Page->addElement($this->getPageTitlePart("مدیریت " . $this->Data['department']->getTableTitle() . " ها"));
		...
		$lnkAdd->setId('adddepartmentlink');
		...
		$lnkSearch->setId('searchdepartmentlink');
