...
*/
class manageprogrammaketype_Design extends FormDesign {
	public function getBodyHTML($command=null)
	{
		$this->FillItems();
		$Page=new Div();
		$Page->setClass("sweet_formtitle");
		$Page->setId("iribfinance_manageprogrammaketype");
		$Page->addElement($this->getPageTitlePart("مدیریت " . $this->Data['programmaketype']->getTableTitle() . ""));
		if($this->getMessage()!="")
	...
	public function FillItems()
	{
		if (key_exists("programmaketype", $this->Data)){
			...
			$this->title->setFieldInfo($this->Data['programmaketype']->getFieldInfo('title'));
