...
*/
class nationalitylist_Design extends FormDesign {
	private $Data;
	/**
	 * @param mixed $Data
	 */
	...
	public function getBodyHTML($command=null)
	{
		...
		$Page->setId("iribfinance_nationalitylist");
		$Page->addElement($this->getPageTitlePart("فهرست " . $this->Data['nationality']->getTableTitle() . " ها"));
		$LTable1=new Div();
		...
		$innerDiv[$i]->setClass("listitem");
			$url=new AppRooter('iribfinance','nationality');
		...
		$Page->addElement($this->getPaginationPart($this->Data['pagecount'],"iribfinance","nationalitylist"));
		$PageLink=new AppRooter('iribfinance','nationalitylist');
	...
	public function FillItems()
	{
		...
		/******** title ********/
		$this->sortby->addOption($this->Data['nationality']->getTableFieldID('title'),$this->getFieldCaption('title'));
		if(isset($_GET['title']))
