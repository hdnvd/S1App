...
*/
class managenationality_Design extends FormDesign {
	public function getBodyHTML($command=null)
	{
		$this->FillItems();
		$Page=new Div();
		$Page->setClass("sweet_formtitle");
		$Page->setId("iribfinance_managenationality");
		$Page->addElement($this->getPageTitlePart("مدیریت " . $this->Data['nationality']->getTableTitle() . ""));
		if($this->getMessage()!="")
		...
		$LTable1->addElement($this->getFieldRowCode($this->flag_flu,$this->getFieldCaption('flag_flu'),null,'لطفا این فیلد را به طور صحیح وارد کنید',null));
	...
	public function FillItems()
	{
		if (key_exists("nationality", $this->Data)){
			...
			/******** title ********/
			$this->title->setValue($this->Data['nationality']->getTitle());
			$this->setFieldCaption('title',$this->Data['nationality']->getFieldInfo('title')->getTitle());
			$this->title->setFieldInfo($this->Data['nationality']->getFieldInfo('title'));
	...
	public function __construct()
	{
		...
		/******* flag_flu *******/
		$this->flag_flu= new FileUploadBox("flag_flu");
		$this->flag_flu->setClass("form-control-file");
