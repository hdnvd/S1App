...
*/
class manageworkunits_Design extends FormDesign {
	private $Data;
	/**
	 * @param mixed $Data
	 */
    ...
    public function setAdminMode($adminMode)
    {
        ...
        $this->itemViewPage = 'workunit';
        if($adminMode==true)
        {
            $this->itemPage = 'manageworkunit';
            $this->listPage = 'manageworkunits';
        }
        else
        {
            $this->itemPage = 'manageuserworkunit';
            $this->listPage = 'manageuserworkunits';
        }
    }
	...
	public function getBodyHTML($command=null)
	{
		...
		$Page->setId("iribfinance_manageworkunits");
		$Page->addElement($this->getPageTitlePart("مدیریت " . $this->Data['workunit']->getTableTitle() . " ها"));
		...
		$lnkSearch->setId('searchworkunitlink');
