...
*/
class paymentlicencelist_Design extends FormDesign {
	private $Data;
	/**
	 * @param mixed $Data
	 */
	...
	public function getBodyHTML($command=null)
	{
		...
		$Page->addElement($this->getPageTitlePart("فهرست " . $this->Data['paymentlicence']->getTableTitle() . " ها"));
		$LTable1=new Div();
		...
		$innerDiv[$i]->setClass("listitem");
			$url=new AppRooter('iribfinance','paymentlicence');
		...
		$Page->addElement($this->getPaginationPart($this->Data['pagecount'],"iribfinance","paymentlicencelist"));
		$PageLink=new AppRooter('iribfinance','paymentlicencelist');
