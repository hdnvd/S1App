...
*/
class managebank_Design extends FormDesign {
	public function getBodyHTML($command=null)
	{
		$this->FillItems();
		$Page=new Div();
		$Page->setClass("sweet_formtitle");
		$Page->setId("iribfinance_managebank");
		$Page->addElement($this->getPageTitlePart("مدیریت " . $this->Data['bank']->getTableTitle() . ""));
		if($this->getMessage()!="")
	...
	public function FillItems()
	{
		if (key_exists("bank", $this->Data)){
			...
			$this->title->setFieldInfo($this->Data['bank']->getFieldInfo('title'));
