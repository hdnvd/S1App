...
*/
class manageclass_Design extends FormDesign {
	public function getBodyHTML($command=null)
	{
		$this->FillItems();
		$Page=new Div();
		$Page->setClass("sweet_formtitle");
		$Page->setId("iribfinance_manageclass");
		$Page->addElement($this->getPageTitlePart("مدیریت " . $this->Data['class']->getTableTitle() . ""));
		if($this->getMessage()!="")
	...
	public function FillItems()
	{
		if (key_exists("class", $this->Data)){
			...
			$this->title->setFieldInfo($this->Data['class']->getFieldInfo('title'));
