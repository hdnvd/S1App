...
use Modules\iribfinance\Controllers\activityController;
...
*/
class activity_Code extends FormCode {
	...
	public function getLoadDesign()
	{
		...
		try{
			$Result=$activityController->load($this->getID());
			$design=new activity_Design();
