...
*/
class manageworkunit_Design extends FormDesign {
	public function getBodyHTML($command=null)
	{
		$this->FillItems();
		$Page=new Div();
		$Page->setClass("sweet_formtitle");
		$Page->setId("iribfinance_manageworkunit");
		$Page->addElement($this->getPageTitlePart("مدیریت " . $this->Data['workunit']->getTableTitle() . ""));
		if($this->getMessage()!="")
		...
		$LTable1->addElement($this->getFieldRowCode($this->minutes,$this->getFieldCaption('minutes'),null,'لطفا این فیلد را به طور صحیح وارد کنید',null));
	...
	public function FillItems()
	{
		if (key_exists("workunit", $this->Data)){
			...
			$this->title->setFieldInfo($this->Data['workunit']->getFieldInfo('title'));
			...
			$this->minutes->setFieldInfo($this->Data['workunit']->getFieldInfo('minutes'));
