...
*/
class manageprogrammaketypes_Design extends FormDesign {
	private $Data;
	/**
	 * @param mixed $Data
	 */
    ...
    public function setAdminMode($adminMode)
    {
        ...
        $this->itemViewPage = 'programmaketype';
        if($adminMode==true)
        {
            $this->itemPage = 'manageprogrammaketype';
            $this->listPage = 'manageprogrammaketypes';
        }
        else
        {
            $this->itemPage = 'manageuserprogrammaketype';
            $this->listPage = 'manageuserprogrammaketypes';
        }
    }
	...
	public function getBodyHTML($command=null)
	{
		...
		$Page->setId("iribfinance_manageprogrammaketypes");
		$Page->addElement($this->getPageTitlePart("مدیریت " . $this->Data['programmaketype']->getTableTitle() . " ها"));
		...
		$lnkAdd->setId('addprogrammaketypelink');
		...
		$lnkSearch->setId('searchprogrammaketypelink');
