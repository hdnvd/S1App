...
*/
class manageemploymenttypes_Design extends FormDesign {
	private $Data;
	/**
	 * @param mixed $Data
	 */
    ...
    public function setAdminMode($adminMode)
    {
        ...
        $this->itemViewPage = 'employmenttype';
        if($adminMode==true)
        {
            $this->itemPage = 'manageemploymenttype';
            $this->listPage = 'manageemploymenttypes';
        }
        else
        {
            $this->itemPage = 'manageuseremploymenttype';
            $this->listPage = 'manageuseremploymenttypes';
        }
    }
	...
	public function getBodyHTML($command=null)
	{
		...
		$Page->setId("iribfinance_manageemploymenttypes");
		$Page->addElement($this->getPageTitlePart("مدیریت " . $this->Data['employmenttype']->getTableTitle() . " ها"));
		...
		$lnkAdd->setId('addemploymenttypelink');
		...
		$lnkSearch->setId('searchemploymenttypelink');
