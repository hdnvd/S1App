...
*/
class managevisatypes_Design extends FormDesign {
	private $Data;
	/**
	 * @param mixed $Data
	 */
    ...
    public function setAdminMode($adminMode)
    {
        ...
        $this->itemViewPage = 'visatype';
        if($adminMode==true)
        {
            $this->itemPage = 'managevisatype';
            $this->listPage = 'managevisatypes';
        }
        else
        {
            $this->itemPage = 'manageuservisatype';
            $this->listPage = 'manageuservisatypes';
        }
    }
	...
	public function getBodyHTML($command=null)
	{
		...
		$Page->setId("iribfinance_managevisatypes");
		$Page->addElement($this->getPageTitlePart("مدیریت " . $this->Data['visatype']->getTableTitle() . " ها"));
		...
		$lnkSearch->setId('searchvisatypelink');
