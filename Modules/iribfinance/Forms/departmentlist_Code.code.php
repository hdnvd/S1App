...
use Modules\iribfinance\Controllers\departmentlistController;
...
*/
class departmentlist_Code extends FormCode {
	private $searchForm='departmentlist';
	...
	public function getLoadDesign()
	{
		...
		try{
			$design=new departmentlist_Design();
			...
			{
				$Result=$departmentlistController->load($this->getHttpGETparameter('pn',-1));
			if(isset($_GET['search']))
					$design=new departmentlistsearch_Design();
	...
	public function search_Click()
	{
		...
		$departmentlistController->setAdminMode($this->getAdminMode());
		$title=$this->getHttpGETparameter('title','');
		$region_fid_ID=$this->getHttpGETparameter('region_fid','');
		$sortby_ID=$this->getHttpGETparameter('sortby','');
		$isdesc_ID=$this->getHttpGETparameter('isdesc','');
		$Result=$departmentlistController->Search($this->getHttpGETparameter('pn',-1),$title,$region_fid_ID,$sortby_ID,$isdesc_ID);
		$design->setData($Result);
