...
*/
class managebanks_Design extends FormDesign {
	private $Data;
	/**
	 * @param mixed $Data
	 */
    ...
    public function setAdminMode($adminMode)
    {
        ...
        $this->itemViewPage = 'bank';
        if($adminMode==true)
        {
            $this->itemPage = 'managebank';
            $this->listPage = 'managebanks';
        }
        else
        {
            $this->itemPage = 'manageuserbank';
            $this->listPage = 'manageuserbanks';
        }
    }
	...
	public function getBodyHTML($command=null)
	{
		...
		$Page->setId("iribfinance_managebanks");
		$Page->addElement($this->getPageTitlePart("مدیریت " . $this->Data['bank']->getTableTitle() . " ها"));
		...
		$lnkSearch->setId('searchbanklink');
