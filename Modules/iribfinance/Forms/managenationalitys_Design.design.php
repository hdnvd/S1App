...
*/
class managenationalitys_Design extends FormDesign {
	private $Data;
	/**
	 * @param mixed $Data
	 */
    ...
    public function setAdminMode($adminMode)
    {
        ...
        $this->itemViewPage = 'nationality';
        if($adminMode==true)
        {
            $this->itemPage = 'managenationality';
            $this->listPage = 'managenationalitys';
        }
        else
        {
            $this->itemPage = 'manageusernationality';
            $this->listPage = 'manageusernationalitys';
        }
    }
	...
	public function getBodyHTML($command=null)
	{
		...
		$Page->setId("iribfinance_managenationalitys");
		$Page->addElement($this->getPageTitlePart("مدیریت " . $this->Data['nationality']->getTableTitle() . " ها"));
		...
		$lnkAdd->setId('addnationalitylink');
		...
		$lnkSearch->setId('searchnationalitylink');
