...
*/
class managerole_Design extends FormDesign {
	public function getBodyHTML($command=null)
	{
		$this->FillItems();
		$Page=new Div();
		$Page->setClass("sweet_formtitle");
		$Page->setId("iribfinance_managerole");
		$Page->addElement($this->getPageTitlePart("مدیریت " . $this->Data['role']->getTableTitle() . ""));
		if($this->getMessage()!="")
	...
	public function FillItems()
	{
		if (key_exists("role", $this->Data)){
			...
			$this->title->setFieldInfo($this->Data['role']->getFieldInfo('title'));
