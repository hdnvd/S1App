...
*/
class manageclasss_Design extends FormDesign {
	private $Data;
	/**
	 * @param mixed $Data
	 */
    ...
    public function setAdminMode($adminMode)
    {
        ...
        $this->itemViewPage = 'class';
        if($adminMode==true)
        {
            $this->itemPage = 'manageclass';
            $this->listPage = 'manageclasss';
        }
        else
        {
            $this->itemPage = 'manageuserclass';
            $this->listPage = 'manageuserclasss';
        }
    }
	...
	public function getBodyHTML($command=null)
	{
		...
		$Page->setId("iribfinance_manageclasss");
		$Page->addElement($this->getPageTitlePart("مدیریت " . $this->Data['class']->getTableTitle() . " ها"));
		...
		$lnkSearch->setId('searchclasslink');
