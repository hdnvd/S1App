...
use Modules\iribfinance\Controllers\classlistController;
...
*/
class classlist_Code extends FormCode {
	private $searchForm='classlist';
	...
	public function getLoadDesign()
	{
		...
		try{
			...
			{
				$Result=$classlistController->load($this->getHttpGETparameter('pn',-1));
	...
	public function search_Click()
	{
		...
		$classlistController->setAdminMode($this->getAdminMode());
		$title=$this->getHttpGETparameter('title','');
		$sortby_ID=$this->getHttpGETparameter('sortby','');
		$isdesc_ID=$this->getHttpGETparameter('isdesc','');
		$Result=$classlistController->Search($this->getHttpGETparameter('pn',-1),$title,$sortby_ID,$isdesc_ID);
		$design->setData($Result);
