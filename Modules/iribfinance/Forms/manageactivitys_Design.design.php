...
*/
class manageactivitys_Design extends FormDesign {
	private $Data;
	/**
	 * @param mixed $Data
	 */
    ...
    public function setAdminMode($adminMode)
    {
        ...
        $this->itemViewPage = 'activity';
        if($adminMode==true)
        {
            $this->itemPage = 'manageactivity';
            $this->listPage = 'manageactivitys';
        }
        else
        {
            $this->itemPage = 'manageuseractivity';
            $this->listPage = 'manageuseractivitys';
        }
    }
	...
	public function getBodyHTML($command=null)
	{
		...
		$Page->setId("iribfinance_manageactivitys");
		$Page->addElement($this->getPageTitlePart("مدیریت " . $this->Data['activity']->getTableTitle() . " ها"));
		...
		$lnkSearch->setId('searchactivitylink');
