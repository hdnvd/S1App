...
*/
class manageregions_Design extends FormDesign {
	private $Data;
	/**
	 * @param mixed $Data
	 */
    ...
    public function setAdminMode($adminMode)
    {
        ...
        $this->itemViewPage = 'region';
        if($adminMode==true)
        {
            $this->itemPage = 'manageregion';
            $this->listPage = 'manageregions';
        }
        else
        {
            $this->itemPage = 'manageuserregion';
            $this->listPage = 'manageuserregions';
        }
    }
	...
	public function getBodyHTML($command=null)
	{
		...
		$Page->setId("iribfinance_manageregions");
		$Page->addElement($this->getPageTitlePart("مدیریت " . $this->Data['region']->getTableTitle() . " ها"));
		...
		$lnkSearch->setId('searchregionlink');
