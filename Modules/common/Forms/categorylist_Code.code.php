...
use Modules\common\Controllers\categorylistController;
...
*/
class categorylist_Code extends FormCode {
	private $searchForm='categorylist';
	...
	public function getLoadDesign()
	{
		...
		try{
			$design=new categorylist_Design();
			...
			{
				$Result=$categorylistController->load($this->getHttpGETparameter('pn',-1));
	...
	public function search_Click()
	{
		...
		$categorylistController->setAdminMode($this->getAdminMode());
		$title=$this->getHttpGETparameter('title','');
		$latintitle=$this->getHttpGETparameter('latintitle','');
		$category_fid_ID=$this->getHttpGETparameter('category_fid','');
		$sortby_ID=$this->getHttpGETparameter('sortby','');
		$isdesc_ID=$this->getHttpGETparameter('isdesc','');
		$Result=$categorylistController->Search($this->getHttpGETparameter('pn',-1),$title,$latintitle,$category_fid_ID,$sortby_ID,$isdesc_ID);
		$design->setData($Result);
