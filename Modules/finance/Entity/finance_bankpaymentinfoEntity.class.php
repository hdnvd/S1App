...
*@creationDate 1396-06-15 - 2017-09-06 13:24
*@lastUpdate 1396-06-15 - 2017-09-06 13:24
...
class finance_bankpaymentinfoEntity extends EntityClass {
	...
	public static $INTERNALREDIRECTURL="internalRedirectURL";
	/**
	 * @return mixed
	 */
	public function getInternalRedirectURL(){
		return $this->getField(finance_bankpaymentinfoEntity::$INTERNALREDIRECTURL);
	}
	/**
	 * @param mixed $InternalRedirectURL
	 */
	public function setInternalRedirectURL($InternalRedirectURL){
		$this->setField(finance_bankpaymentinfoEntity::$INTERNALREDIRECTURL,$InternalRedirectURL);
	}
}
?>