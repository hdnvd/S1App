...
*/
class managepayrequests_Design extends FormDesign {
	private $Data;
	/**
	 * @param mixed $Data
	 */
    ...
    public function setAdminMode($adminMode)
    {
        ...
        $this->itemViewPage = 'payrequest';
        if($adminMode==true)
        {
            $this->itemPage = 'managepayrequest';
            $this->listPage = 'managepayrequests';
        }
        else
        {
            $this->itemPage = 'manageuserpayrequest';
            $this->listPage = 'manageuserpayrequests';
        }
    }
	...
	public function getBodyHTML($command=null)
	{
		...
		$Page->setId("finance_managepayrequests");
		$Page->addElement($this->getPageTitlePart("مدیریت " . $this->Data['payrequest']->getTableTitle() . " ها"));
		...
		$lnkAdd->setId('addpayrequestlink');
		...
		$lnkSearch->setId('searchpayrequestlink');
