...
*/
class usertransactionlistController extends Controller {
	private $PAGESIZE=10;
	public function load($PageNum)
	{
		...
		$q=new QueryLogic();
		$q->addCondition(new FieldCondition("role_systemuser_fid",$role_systemuser_fid,LogicalOperator::Equal));
        ...
        $pay=new Payment();
        $result['balance']=$pay->getBalance(1);
		$result['param1']="";
