...
use Modules\shift\Controllers\madraklistController;
...
*/
class madraklist_Code extends FormCode {
	private $searchForm='madraklist';
	...
	{
		$madraklistController=new madraklistController();
		$translator=new ModuleTranslator("shift");
		$translator->setLanguageName(CurrentLanguageManager::getCurrentLanguageName());
		try{
			$design=new madraklist_Design();
			...
			{
				$Result=$madraklistController->load($this->getHttpGETparameter('pn',-1));
	...
	public function search_Click()
	{
		...
		$madraklistController->setAdminMode($this->getAdminMode());
		...
		$Result=$madraklistController->Search($this->getHttpGETparameter('pn',-1),$title,$zarib,$sortby_ID,$isdesc_ID);
		$design->setData($Result);
