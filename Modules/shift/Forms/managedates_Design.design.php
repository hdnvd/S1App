...
*/
class managedates_Design extends FormDesign {
	private $Data;
	/**
	 * @param mixed $Data
	 */
    ...
    public function setAdminMode($adminMode)
    {
        ...
        $this->itemViewPage = 'date';
        if($adminMode==true)
        {
            $this->itemPage = 'managedate';
            $this->listPage = 'managedates';
        }
        else
        {
            $this->itemPage = 'manageuserdate';
            $this->listPage = 'manageuserdates';
        }
    }
	...
	public function getBodyHTML($command=null)
	{
		...
		$lnkSearch->setId('searchdatelink');
