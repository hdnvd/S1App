...
*/
class managemorakhasis_Design extends FormDesign {
	private $Data;
	/**
	 * @param mixed $Data
	 */
    ...
    public function setAdminMode($adminMode)
    {
        ...
        $this->itemViewPage = 'morakhasi';
        if($adminMode==true)
        {
            $this->itemPage = 'managemorakhasi';
            $this->listPage = 'managemorakhasis';
        }
        else
        {
            $this->itemPage = 'manageusermorakhasi';
            $this->listPage = 'manageusermorakhasis';
        }
    }
	...
	public function getBodyHTML($command=null)
	{
		...
		$Page->setId("shift_managemorakhasis");
		$Page->addElement($this->getPageTitlePart("مدیریت " . $this->Data['morakhasi']->getTableTitle() . " ها"));
		...
		$lnkSearch->setId('searchmorakhasilink');
