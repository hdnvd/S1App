...
*/
class manageshifttypes_Design extends FormDesign {
	private $Data;
	/**
	 * @param mixed $Data
	 */
    ...
    public function setAdminMode($adminMode)
    {
        ...
        $this->itemViewPage = 'shifttype';
        if($adminMode==true)
        {
            $this->itemPage = 'manageshifttype';
            $this->listPage = 'manageshifttypes';
        }
        else
        {
            $this->itemPage = 'manageusershifttype';
            $this->listPage = 'manageusershifttypes';
        }
    }
	...
	public function getBodyHTML($command=null)
	{
		...
		$Page->setId("shift_manageshifttypes");
		$Page->addElement($this->getPageTitlePart("مدیریت " . $this->Data['shifttype']->getTableTitle() . " ها"));
		...
		$lnkSearch->setId('searchshifttypelink');
