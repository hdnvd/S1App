...
*/
class manageeshteghals_Design extends FormDesign {
	private $Data;
	/**
	 * @param mixed $Data
	 */
    ...
    public function setAdminMode($adminMode)
    {
        ...
        $this->itemViewPage = 'eshteghal';
        if($adminMode==true)
        {
            $this->itemPage = 'manageeshteghal';
            $this->listPage = 'manageeshteghals';
        }
        else
        {
            $this->itemPage = 'manageusereshteghal';
            $this->listPage = 'manageusereshteghals';
        }
    }
	...
	public function getBodyHTML($command=null)
	{
		...
		$Page->setId("shift_manageeshteghals");
		$Page->addElement($this->getPageTitlePart("مدیریت " . $this->Data['eshteghal']->getTableTitle() . " ها"));
		...
		$lnkSearch->setId('searcheshteghallink');
