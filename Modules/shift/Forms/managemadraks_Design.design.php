...
*/
class managemadraks_Design extends FormDesign {
	private $Data;
	/**
	 * @param mixed $Data
	 */
    ...
    public function setAdminMode($adminMode)
    {
        ...
        $this->itemViewPage = 'madrak';
        if($adminMode==true)
        {
            $this->itemPage = 'managemadrak';
            $this->listPage = 'managemadraks';
        }
        else
        {
            $this->itemPage = 'manageusermadrak';
            $this->listPage = 'manageusermadraks';
        }
    }
	...
	public function getBodyHTML($command=null)
	{
		...
		$Page->setId("shift_managemadraks");
		$Page->addElement($this->getPageTitlePart("مدیریت " . $this->Data['madrak']->getTableTitle() . " ها"));
		...
		$lnkSearch->setId('searchmadraklink');
