...
*/
class managemadrak_Design extends FormDesign {
	public function getBodyHTML($command=null)
	{
		$this->FillItems();
		$Page=new Div();
		$Page->setClass("sweet_formtitle");
		$Page->setId("shift_managemadrak");
		$Page->addElement($this->getPageTitlePart("مدیریت " . $this->Data['madrak']->getTableTitle() . ""));
		if($this->getMessage()!="")
	...
	public function FillItems()
	{
		if (key_exists("madrak", $this->Data)){
			...
			$this->title->setFieldInfo($this->Data['madrak']->getFieldInfo('title'));

			/******** zarib ********/
			$this->zarib->setValue($this->Data['madrak']->getZarib());
			$this->setFieldCaption('zarib',$this->Data['madrak']->getFieldInfo('zarib')->getTitle());
			$this->zarib->setFieldInfo($this->Data['madrak']->getFieldInfo('zarib'));
