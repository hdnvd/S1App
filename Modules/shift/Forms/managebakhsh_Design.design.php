...
*/
class managebakhsh_Design extends FormDesign {
	public function getBodyHTML($command=null)
	{
		$this->FillItems();
		$Page=new Div();
		$Page->setClass("sweet_formtitle");
		$Page->setId("shift_managebakhsh");
		$Page->addElement($this->getPageTitlePart("مدیریت " . $this->Data['bakhsh']->getTableTitle() . ""));
		if($this->getMessage()!="")
		...
		$LTable1->addElement($this->getFieldRowCode($this->sakhtikar,$this->getFieldCaption('sakhtikar'),null,'لطفا این فیلد را به طور صحیح وارد کنید',null));
	...
	public function FillItems()
	{
		if (key_exists("bakhsh", $this->Data)){
			...
			$this->title->setFieldInfo($this->Data['bakhsh']->getFieldInfo('title'));
			...
			$this->sakhtikar->setFieldInfo($this->Data['bakhsh']->getFieldInfo('sakhtikar'));
